...
class FlightControl:
    ...
    def land(self): log.info("[%s] landed", self.drone_id)
...
def build_machine(drone_id: str, delivery_timeout_ms: int, nav: NavigationModule,
    ...
    transitions = [
        ...
        {"trigger": "medicine_loaded", "source": "load_medicine", "target": "travel_to_client",
         "effect": "effect_medicine_loaded(*)"},
        {"trigger": "cancel", "source": "travel_to_client", "target": "returning", "effect": "effect_cancel_travel"},
        {"trigger": "arrived", "source": "travel_to_client", "target": "deliver",
         "effect": f"effect_arrived; start_timer('delivery_timeout', {delivery_timeout_ms})"},
        {"trigger": "delivery_completed", "source": "deliver", "target": "returning",
